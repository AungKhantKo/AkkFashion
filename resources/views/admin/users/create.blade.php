                ...
                <div class="row py-2">
                    <div class="offset-lg-1 col-lg-10">
                        ...
                        <div class="mb-3 ">
                            ...
                            <input type="Phone" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" name="phone" id="phone" placeholder="">
                        ...
                        <div class="mb-3 ">
                            ...
                            <textarea class="form-control {{$errors->has('address') ? 'is-invalid' : ''}}" placeholder="" name="address" id="address"></textarea>
