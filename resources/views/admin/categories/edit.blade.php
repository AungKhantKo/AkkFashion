...
<div class="container-fluid px-4">
        ...
        <div class="container-md">
            <form action="{{route('backend.categories.store')}}" method="POST" enctype="multipart/form-data" class="border">
                {{csrf_field()}}
                <div class="row py-2">
                    <div class="offset-lg-1 col-lg-10">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control {{$errors->has('image') ? 'is-invalid' : ''}}" type="file" name="image" value="{{$category->image}}" id="formFimagele">
