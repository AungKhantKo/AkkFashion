        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="small mb-1">{{$item->codeNo}}</div>
                        ...
                        <div class="d-flex">
                            ...
                            <button class="btn btn-outline-dark flex-shrink-0 addToCart" type="button" data-id="{{$item->id}}" data-name="{{$item->name}}" data-codeno="{{$item->codeNo}}" data-price="{{$item->price}}" data-discount="{{$item->discount}}">
